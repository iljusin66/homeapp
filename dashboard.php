                ...
                <div class="row rounded-3">
                    ...
                    ?>
                        <div class="tile col-12 col-sm-2">
                            ...
                            <div class="text-center"><a href="<?= c_MainUrl; ?>nastaveniMeridla.php?idm=<?= $aMeridlo["id"] ?>&<?= time() ?>" class="btn btn-primary my-2 col-12"><i class="bi-gear me-1"></i> <?= __('Nastavení') ?></a></div>
                        </div>
                    <?php endforeach;
                    endif;
                    ?>
