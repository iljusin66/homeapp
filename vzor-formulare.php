        ...
        <div class="row">
            <div class="col p-3 bg-white m-2 rounded-3">
                <div class="row">
                    ...
                    <div class="col ps-0">
                        <h1 class="fs-3 ps-0">Vzor furmuláře
                        </h1>
                    </div>
                </div>
                <div class="row pt-0">
                    ...
                    <div class="col" style="min-height: 85vh">
                        <div id="dataContainer" class="row">
                            <form class="p-1 pt-0 me-1 col-l-10 col-12" id="frmZamestnanecEdit" action="zamestnanecEdit.php" method="POST" novalidate>
                                <input type="hidden" name="idzamestnance" value="">
                                ...
                                <fieldset class="row">
                                    ...
                                    <div class="col-4">
                                        <div class="input-group input-group-sm mb-1 ">
                                            ...
                                            <input type="text" data-kontrolaZmeny name="jmeno" id="jmeno" value="" class="form-control">
                                    ...
                                    <div class="col-4">
                                        <div class="input-group input-group-sm mb-1 ">
                                            ...
                                            <input type="text" data-kontrolaZmeny name="odbornost" id="odbornost" value="" class="form-control">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-4">
                                        <div class="input-group input-group-sm mb-1 ">
                                            ...
                                            <input type="text" data-kontrolaZmeny name="osloveni" id="osloveni" value="" class="form-control">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-4">
                                        <div class="input-group input-group-sm mb-1 ">
                                            ...
                                            <input type="email" name="email_f" id="email_f" value="" class="form-control">
                                        </div>
                                    </div>
                                    <div class="col-12">
                                        <div class="input-group input-group-sm mb-1 ">
                                            <label class="input-group-text col-1" for="poznamka" id="label_poznamka" style="font-size: .875rem; min-width:8.5vw;">Poznámka</label>
                                            <input type="text" data-kontrolaZmeny name="poznamka" id="poznamka" value="" class="form-control">
                                        </div>
                                    </div>
                                    <div class="col-12">
                                        <div class="input-group input-group-sm ">
                                            ...
                                            <input type="text" data-kontrolaZmeny name="pocitane_vykony" id="pocitane_vykony" value="" class="form-control">
                                        </div>
                                    </div>
                                </fieldset>
                                <fieldset class="row mt-3">
                                    ...
                                    <div class="col-3">
                                        <div class="input-group input-group-sm mb-1">
                                            ...
                                            <input type="datetime-local" class="form-control form-control-sm" id="platnost_certifikatu_do" name="platnost_certifikatu_do" value="">
                                        </div>
                                    </div>
                                    <div class="col-9"></div>
                                    ...
                                    <div class="col-3">
                                        <div class="input-group input-group-sm mb-1">
                                            ...
                                            <input type="date" class="form-control form-control-sm" id="platnost_heslo_sukl_do" name="platnost_heslo_sukl_do" value="">
                                        </div>
                                    </div>
                                    <div class="col-3">
                                        <div class="input-group input-group-sm mb-1 ">
                                            <label class="input-group-text col-4" for="sukl_heslo" id="label_sukl_heslo" style="font-size: .875rem;">Heslo SUKL</label>
                                            <input type="text" data-kontrolaZmeny name="sukl_heslo" id="sukl_heslo" value="" class="form-control">
                                        </div>
                                    </div>
                                    <div class="col-5">
                                        <div class="input-group input-group-sm mb-1 ">
                                            <label class="input-group-text col-2" for="sukl_uuid" id="label_sukl_uuid" style="font-size: .875rem;">UUID SUKL</label>
                                            <input type="text" data-kontrolaZmeny name="sukl_uuid" id="sukl_uuid" value="" class="form-control">
                                        </div>
                                    </div>
                                    <div class="col">
                                ...
                                <fieldset class="row mt-3">
                                    ...
                                    <div class="col-4">
                                        <div class="input-group input-group-sm mb-1 ">
                                            ...
                                            <input type="text" data-kontrolaZmeny name="smluvnimzda" id="smluvnimzda" value="" class="form-control text-end">
                                        </div>
                                    </div>
                                    <div class="col-4">
                                        <div class="input-group input-group-sm mb-1 ">
                                            <label class="input-group-text col-4" id="label_pausal" for="pausal" style="font-size: .875rem;">Paušál</label>
                                            <input type="text" data-kontrolaZmeny name="pausal" id="pausal" value="" class="form-control text-end">
                                        </div>
                                    </div>
                                    <div class="col-4">
                                        <div class="input-group input-group-sm mb-1 ">
                                            <label class="input-group-text col-4" for="hodinovamzda" id="label_hodinovamzda" style="font-size: .875rem;">Hodinová mzda</label>
                                            <input type="text" data-kontrolaZmeny name="hodinovamzda" id="hodinovamzda" value="" class="form-control text-end">
                                        </div>
                                    </div>
                                    <div class="col-4">
                                    ...
                                    <div class="col-4">
                                        <div class="form-check form-switch mt-1 ms-1">
                                            ...
                                            <input  data-bs-toggle="collapse" data-bs-target="#collapseFaktury" class="form-check-input" type="checkbox" data-kontrolaZmeny id="b_ico" name="b_ico" value="1" checked>
                                        </div>
                                    </div>
                                    <div class="col-4"></div>
                                </fieldset>
                                ...
                                <fieldset class="row mt-3">
                                    ...
                                    <div class="col-8">
                                        <div class="input-group input-group-sm mb-1 ">
                                            ...
                                            <input type="text" placeholder='nepočítané výkony (oddělené čárkou)' data-kontrolaZmeny name="vedeniordinace_mimovykony_<?= $i ?>" id="vedeniordinace_mimovykony_<?= $i ?>" value="" class="form-control">
                                        </div>
                                    </div>
                                    <?php endfor ?>
                                </fieldset>
                                <fieldset class="row mt-3">
                                    ...
                                    <div class="col-4">
                                        <div class="input-group input-group-sm mb-1">
                                            ...
                                            <input type="text" data-kontrolaZmeny name="uvazek" id="uvazek" value="" class="form-control text-end">
                                        </div>
                                    </div>
                                    <div class="col-4">
                                        <div class="input-group input-group-sm mb-1">
                                            ...
                                            <input type="text" data-kontrolaZmeny name="proc_hodnotayvykonu_ord" id="proc_hodnotayvykonu_ord" value="" class="form-control text-end">
                                        </div>
                                    </div>
                                    <div class="col-4">
                                        <div class="input-group input-group-sm mb-1">
                                            ...
                                            <input type="text" data-kontrolaZmeny name="proc_hodnotayvykonu_ost" id="proc_hodnotayvykonu_ost" value="" class="form-control text-end">
                                        </div>
                                    </div>
                                </fieldset>
                                <fieldset class="row mt-3">
                                    ...
                                    <div class="col-4">
                                        <div class="input-group input-group-sm mb-1">
                                            ...
                                            <input type="text" data-kontrolaZmeny name="proc_hodnotayvykonu_cli" id="proc_hodnotayvykonu_cli" value="" class="form-control text-end">
                                        </div>
                                    </div>
                                    <div class="col-4">
                                ...
                                <fieldset class="row mt-3">
                                    ...
                                    <div class="col-4">
                                        <div class="form-check form-switch mt-1 ms-1">
                                            ...
                                            <input class="form-check-input" type="checkbox" data-kontrolaZmeny id="b_vlastnizdanenidohody" name="b_vlastnizdanenidohody" value="1" >
                                        </div>
                                    </div>
                                    <div class="col-4">
                                ...
                                <fieldset class="row mt-3">
                                    ...
                                    <div class="col-3">
                                        <div class="input-group input-group-sm mb-1 ">
                                            ...
                                            <input type="text" data-kontrolaZmeny name="odecet" id="odecet" value="" class="form-control text-end">
                                        </div>                                        
                                    </div>
                                    <div class="col-3">
                                        <div class="input-group input-group-sm mb-1 ">
                                            <label class="input-group-text col-5" id="label_odecet_datum_do" for="odecet_datum_do" style="font-size: .875rem;">Platné do</label>
                                            <input type="date" class="form-control form-control-sm " id="odecet_datum_do" name="odecet_datum_do" value="">
                                        </div>
                                    </div>
                                    <div class="col-6">
                                        <div class="input-group input-group-sm mb-1 ">
                                            <label class="input-group-text col-2" id="label_odecet_popis" for="odecet_popis" style="font-size: .875rem;">Poznámka</label>
                                            <input type="text" data-kontrolaZmeny class="form-control form-control-sm" id="odecet_popis" name="odecet_popis" value="">
                                        </div>
                                    </div>
                                ...
                                <fieldset class="row mt-3">
                                    ...
                                    <div class="col-3">
                                        <div class="input-group input-group-sm mb-1 ">
                                            ...
                                            <input type="text" data-kontrolaZmeny name="priplatek[<?= $id_cis_priplatu ?>]" id="priplatek_<?= $id_cis_priplatu ?>" value="" class="form-control text-end">
                                        </div>
                                    </div>
                                    <div class="col-3">
                                        <div class="input-group input-group-sm">
                                            ...
                                            <input type="date" class="form-control form-control-sm " id="priplatek_datum_do[<?= $id_cis_priplatu ?>]" name="priplatek_datum_do[<?= $id_cis_priplatu ?>]" value="">
                                        </div>
                                    </div>
                                    <div class="col-6">
                                        <div class="input-group input-group-sm">
                                            ...
                                            <input type="text" data-kontrolaZmeny class="form-control form-control-sm " id="priplatek_popis[<?= $id_cis_priplatu ?>]" name="priplatek_popis[<?= $id_cis_priplatu ?>]" value="">
                                        </div>
                                    </div>
                                ...
                                <fieldset class="row mt-3">
                                    ...
                                    <div class="col-3">
                                        <div class="input-group input-group-sm mb-1 ">
                                            ...
                                            <input type="text" data-kontrolaZmeny name="banka_pocatecni_stav" id="banka_pocatecni_stav" value="" class="form-control text-end">
                                        </div>                                        
                                    </div>                                    
                                </fieldset>
